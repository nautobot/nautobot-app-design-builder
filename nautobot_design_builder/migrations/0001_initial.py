    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', nautobot.extras.models.statuses.StatusField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='nautobot_design_builder_design_related', to='extras.status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(auto_now=True, null=True)),
                ('_custom_field_data', models.JSONField(blank=True, default=dict, encoder=django.core.serializers.json.DjangoJSONEncoder)),
                ('design_instance', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='nautobot_design_builder.designinstance')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('journal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nautobot_design_builder.journal')),
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ],
            options={
                'abstract': False,
