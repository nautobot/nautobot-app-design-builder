# Generated by Django 3.2.25 on 2024-05-14 19:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deployment', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='journals', to='nautobot_design_builder.deployment')),
        ...
        migrations.AddField(
            ...
            name='design',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, related_name='instances', to='nautobot_design_builder.design'),
        ),
        migrations.AddField(
            model_name='deployment',
            name='status',
            field=nautobot.extras.models.statuses.StatusField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='deployment_statuses', to='extras.status'),
        ),
        migrations.AddField(
            model_name='deployment',
            name='tags',
